...
<template>
    <div
        class="bg-pixl-dark text-pixl-light h-dvh w-full overflow-clip relative"
    >
        <!-- Background image -->
        ...
        <main
            class="grid place-items-center h-full isolate max-w-[1000px] mx-auto px-8"
        >
            <div class="flex gap-16 justify-between items-center w-full">
                <!-- Left panel -->
                <div>
                    <div class="flex gap-3 items-baseline">
                        ...
                        <div><p>Word Stack</p></div>
                    </div>
                </div>

                <!-- Right panel -->
                <div class="w-80 max-w-full pb-16">
                    <h1 class="text-pixl text-3xl">
                        A place for the cool squares.
                    </h1>
                    <div class="flex flex-col gap-3 mt-16 w-68 text-center">
                        <a
                            class="bg-pixl-dark/50 hover:bg-pixl-dark/60 active:bg-pixl-dark/75 border border-pixl/50 hover:border-pixl/60 active:border-pixl/75 px-4 py-1.5 text-pixl"
                            href="#"
                        ...
                        <p>or</p>
                        <a
                            class="bg-pixl hover:bg-pixl/90 active:bg-pixl/95 border border-transparent px-4 py-1.5 text-pixl-dark"
                            href="#"
                            >Create an Account</a
                        >
                        <p class="text-sm mt-20 text-left">
        ...
        <footer class="fixed bottom-0 inset-x-0 pb-3">
            <div class="flex flex-col gap-1.5 items-center text-pixl p-4">
            ...
            <!-- White noise -->
            <div
                class="absolute bottom-0 h-4 inset-x-0 bg-[url(/images/white-noise.gif)]"
            ></div>
        </footer>
    </div>
</template>
